...
//           {fileUploadError ? 
//            (<span className="text-red-700">Error uploading image(image must be less than 2mb)
//             </span>) :
...
//           <div 
//           key={listing._id} className="dorder rounded-lg p-3 flex justify-between items-center gap-4">
